	...
	const quizData = [
		{
			...
			questions: [
				...
				{
					questionText:
						"What is the name of the lawyer who defends Tom Robinson?",
					category: "Characters",
					difficulty: "medium",
					choices: [
				...
				{
					questionText:
						"What does Scout learn about Boo Radley throughout the novel?",
					category: "Plot",
					difficulty: "medium",
					choices: [
						{ choiceText: "He is a dangerous criminal.", isCorrect: false },
						{
							choiceText: "He is a recluse who is kind and protective.",
							isCorrect: true,
						},
						{
							choiceText: "He is secretly the mayor of Maycomb.",
							isCorrect: false,
						},
						{
							choiceText: "He moved away at the beginning of the story.",
							isCorrect: false,
						},
					],
				},
		...
		},
		{
			quizTitle: "1984",
			quizDescription:
				"Test your knowledge of George Orwell's dystopian masterpiece.",
			questions: [
				{
					questionText:
						'In George Orwell\'s "1984", what is the name of the totalitarian ruling party?',
					category: "Politics",
					difficulty: "medium",
					choices: [
				...
				},
				{
					...
					choices: [
						{
							choiceText: "To make communication more efficient.",
							isCorrect: false,
						},
						{
							choiceText: "To expand the vocabulary of Oceania.",
							isCorrect: false,
						},
						{
							choiceText: "To limit freedom of thought by limiting language.",
							isCorrect: true,
						},
						{
							choiceText: "To translate ancient texts into modern English.",
							isCorrect: false,
						},
					],
				},
		...
		},
		{
			...
			questions: [
				{
					questionText:
						'Which of these is NOT one of the Pevensie children in C.S. Lewis\'s "The Chronicles of Narnia"?',
					category: "Characters",
					difficulty: "medium",
					choices: [
				...
				{
					questionText:
						"Through which object do the Pevensie children first enter Narnia?",
					category: "Setting",
					difficulty: "easy",
					choices: [
		...
		},
		{
			...
			quizDescription:
				"Test your knowledge of the wizarding world created by J.K. Rowling.",
			questions: [
				{
					questionText:
						"What is the primary setting for most of the Harry Potter series?",
					category: "Setting",
					difficulty: "easy",
					choices: [
						...
						{
							choiceText: "Hogwarts School of Witchcraft and Wizardry",
							isCorrect: true,
						},
				...
				{
					questionText:
						"What is the name of the magical object that allows wizards to travel between designated fireplaces?",
		...
		},
		{
			quizTitle: "Moby Dick",
			quizDescription:
				"Questions about Herman Melville's epic tale of Captain Ahab and the white whale.",
			questions: [
				{
					questionText:
						"Which classic novel features a white whale named Moby Dick?",
					category: "Literature",
					difficulty: "easy",
					choices: [
						{
							choiceText: "Twenty Thousand Leagues Under the Seas",
							isCorrect: false,
						},
				...
				{
					questionText:
						"What is the name of the ship on which Captain Ahab obsessively hunts Moby Dick?",
					category: "Plot",
					difficulty: "medium",
					choices: [
